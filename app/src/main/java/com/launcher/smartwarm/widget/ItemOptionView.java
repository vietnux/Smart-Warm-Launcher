package com.launcher.smartwarm.widget;
...
import com.launcher.smartwarm.activity.homeparts.HpAppEditApplier;
import com.launcher.smartwarm.interfaces.DropTargetListener;
import com.launcher.smartwarm.manager.Setup;
import com.launcher.smartwarm.model.Item;
import com.launcher.smartwarm.util.DragAction.Action;
import com.launcher.smartwarm.util.DragHandler;
import com.launcher.smartwarm.util.Tool;
import com.launcher.smartwarm.viewutil.PopupIconLabelItem;
...
public final class ItemOptionView extends FrameLayout {
    ...
    public final void showPopupMenuForItem(float x, float y, @NonNull List<PopupIconLabelItem> popupItem, com.mikepenz.fastadapter.listeners.ClickEventHook<PopupIconLabelItem> listener) {
...
//            _overlayPopupAdapter.withOnClickListener(listener);
    ...
    public void showItemPopup(final HomeActivity homeActivity) {
        ...
        showPopupMenuForItem(x, y, itemList, new com.mikepenz.fastadapter.listeners.ClickEventHook<PopupIconLabelItem>() {
            @Override
            public void onClick(@NonNull View v, int i, @NonNull FastAdapter<PopupIconLabelItem> adapter, @NonNull PopupIconLabelItem item) {
                Item dragItem;
